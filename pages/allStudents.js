...
function allStudents() {
    ...
    const handleDeleteStudent = async (studentId) => {
        try {
            await axios.delete(` http://localhost:8000/api/deleteStudent/${studentId}/delete`);
    ...
    const fetchStudents = async () => {
        try {
            const response = await axios.get('http://localhost:8000/api/fetchStudents');
            ...
            <section class="text-gray-600 body-font">
                <div class="container px-5 py-24 mx-auto">
                    <div class="flex flex-col text-center w-full mb-20">
                        <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Our Students</h1>
                    </div>
                        ...
                        {students.map((student) => (
                            ...
                            <div class="p-2 lg:w-1/3 md:w-1/2 w-full" key={student.id}>
                                <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg">
                                    ...
                                    <button
                                        className="ml-auto px-4 py-2 bg-red-500 text-white rounded pl-3"
