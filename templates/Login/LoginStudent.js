...
function LoginStudent() {
    const url = 'http://localhost:8000/api/loginStudent';
        ...
        <section class="text-gray-600 body-font px-14">
            <div class="container px-5  mx-auto flex flex-wrap items-center">
                ...
                <div class="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
                    ...
                    <button onClick={LoginStudentr} class="text-white bg-gray-900 border-0 py-2 px-8 focus:outline-none hover:bg-gray-700 rounded text-lg">
                        Login
                    </button>
                    <div className='flex'>
